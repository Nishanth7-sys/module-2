...
export default function HomePage() {
  ...
  const calculateBitcoinReturns = (investmentAmount, initialPrice, investmentYear, currentYear, currentPrice) => {
    const yearsPassed = currentYear - investmentYear;
    const bitcoinPurchased = investmentAmount / initialPrice;
    const currentInvestmentValue = bitcoinPurchased * currentPrice;
    const investmentValueAtStartYear = bitcoinPurchased * initialPrice;
  ...
  return (
    <main className="container">
      ...
      {initUser()}
      <div>
        <h2>Calculate Bitcoin Returns</h2>
        ...
        <button
          onClick={() => {
            ...
            const returns = calculateBitcoinReturns(investmentAmount, initialPrice, investmentYear, currentYear, currentPrice);
